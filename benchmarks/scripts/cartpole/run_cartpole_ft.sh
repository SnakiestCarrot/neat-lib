...
# =============================================================================
# CartPole — fixed-topology baseline (NEAT with structural search disabled).
# Topology mutations and weight-based speciation distance are zeroed out.
# =============================================================================
...
echo "CartPole FT benchmark — $NUM_RUNS runs"
